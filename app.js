...
const FOOD_DB = {
  ...
  'квас': { kcal: 27 }, 'кваса': { kcal: 27 }, 'компот': { kcal: 58 }, 'компота': { kcal: 58 }, 'морс': { kcal: 40 }, 'морса': { kcal: 40 },
  'сок': { kcal: 45 }, 'сока': { kcal: 45 }, 'апельсиновый сок': { kcal: 45 }, 'яблочный сок': { kcal: 46 },
  'томатный сок': { kcal: 17 }, 'вишневый сок': { kcal: 51 }, 'гранатовый сок': { kcal: 56 },
  'фреш': { kcal: 48 }, 'смузи': { kcal: 60 }, 'лимонад': { kcal: 40 }, 'лимонада': { kcal: 40 },
