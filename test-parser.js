...
const checks = [
  ...
  // «куриного», «чёрный хлеб» в базе отсутствовал
  ['тарелка куриного супа', 0, 84],
...
// + составные ключи по набору слов («бутербродА с сыром» = «бутерброд с сыром»).
{
  const detailed = [
    ...
    // 0.3.21: «тарелка куриного супа» — порция 200 г куриного супа, не «суп 100 г»
    ['тарелка куриного супа', [['куриный суп', 1, 200, 84]]],
    // 0.3.22: с союзом «и» — суп порцией, хлеб куском 40 г
    ['тарелка куриного супа и кусок чёрного хлеба', [['куриный суп', 1, 200, 84], ['чёрный хлеб', 1, 40, 80]]]
  ];
